...
ListenRadio = Radiobutton(Row1Frame, text="Listen", bg="#e6e6e6", variable=listenorconnect, value="LISTEN", command=listenmode) 
ConnectRadio = Radiobutton(Row1Frame,text="Connect", bg="#e6e6e6", variable=listenorconnect, value="CONNECT", command=connectmode)
ListenRadio.select()
